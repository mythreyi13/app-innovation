...
app.get('/topperformers', function (request, response) {
  pg.connect(process.env.DATABASE_URL, function(err, client, done) { 
    client.query('SELECT B.FirstName as name, A.FinServ__TotalRevenue__c as Revenue, A.Id as id FROM salesforce.account A, salesforce.user B', function(err, result) {
      done();
      if (err)
